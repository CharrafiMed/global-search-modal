...
@php
    ...
    $classes = [
        ...
        '[&_.fi-modal-close-btn]:!top-2 [&_.fi-modal-close-btn]:!end-2 [&_.fi-modal-close-btn]:!p-0.5 [&_.fi-modal-close-btn]:size-6 ',
        ...
        '[&_.results-container]:[scrollbar-color:rgba(156,163,175,0.7)_transparent]',
